...
La version **1.7.1** fournit une interface interactive et six commandes explicites :
...
La version 1.7.1 cible les environnements Linux utilisant **systemd**. Les
...
sélectionnables par Installer 1.7.1.
