...
def test_load_release_catalog_reads_repository_catalog() -> None:
    ...
    assert catalog.platform_version == "1.0.118"
    assert catalog.default_platform_version == "1.0.118"
    assert catalog.releases[0].agent_version == "1.29.19"
    assert catalog.releases[0].vision_version == "1.22.14"
