...
Ce guide installe **Ohana-Installer 1.7.1**, puis Ohana-Agent et Ohana-Vision
...
```bash
mkdir -p "$HOME/ohana-installer-1.7.1"
cd "$HOME/ohana-installer-1.7.1"

curl --fail --location --remote-name \
  https://github.com/cedric-HAOS/Ohana-Installer/releases/download/v1.7.1/ohana_installer-1.7.1-py3-none-any.whl
curl --fail --location --remote-name \
  https://github.com/cedric-HAOS/Ohana-Installer/releases/download/v1.7.1/ohana_installer-1.7.1.tar.gz
curl --fail --location --remote-name \
  https://github.com/cedric-HAOS/Ohana-Installer/releases/download/v1.7.1/SHA256SUMS
```
...
sudo /opt/ohana-installer/bin/python -m pip install \
  ./ohana_installer-1.7.1-py3-none-any.whl
